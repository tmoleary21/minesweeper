...
class Cell{
  ...
  public:
    ...
    static void initCellTextures(){
        if(!Cell::defaultTexture.loadFromFile("textures/default.png")){
            throw "Could not load texture file textures/default.png\n";
        }
        if(!Cell::emptyTexture.loadFromFile("textures/empty.png")){
            throw "Could not load texture file textures/empty.png\n";
        }
        //TODO: Need to change source files of next two
        if(!Cell::flagTexture.loadFromFile("textures/default.png")){
            throw "Could not load texture file textures/default.png\n";
        }
        if(!Cell::mineTexture.loadFromFile("textures/default.png")){
            throw "Could not load texture file textures/default.png\n";
        }
    }
};
